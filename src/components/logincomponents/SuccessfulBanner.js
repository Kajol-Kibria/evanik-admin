...
export default function SuccessfulBanner() {
  return (
    <div>
        <div className='absolute right-0 left-0 z-50 text-center py-5 sm:py-4 text-[#1f674f] bg-[#c8e3da] text-xs sm:text-sm font-semibold'>
