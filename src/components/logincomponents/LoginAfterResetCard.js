...
export default function LoginAfterResetCard() {
  return (
    <div>
        <div className='flex sm:relative fixed top-0 bottom-0 left-0 right-0 items-center justify-center'>
                    ...
                    <div className='py-5  px-10 border shd border-[#e0e1ff] mt-8 rounded-xl'>
                        ...
                        <form className=''>
                            ...
                            <div className='flex gap-4 items-center justify-between my-8'>
                                ...
                                <Link href='/onboarding' className='text-white font-semibold hover:bg-[#5356f7] transform transition-all duration-200 bg-blue py-3 sm:px-10 px-6 text-sm sm:text-base rounded-xl'>Login</Link>
                            </div> 
                        </form>
                    </div>
                    </div>
