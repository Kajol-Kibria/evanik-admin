...
export function TotalMessagesDonut() {
  return (
    <div className="sm:h-[40vh] px-8 py-5 rounded-xl sm:w-1/2 shd">

    <div className=" mx-auto ">
      <div className=" pb-0">
        
        <div className="text-lg font-semibold text-blue ">Total messages sent</div>
      </div>
