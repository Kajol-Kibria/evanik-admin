  ...
  return (
    <div>
      ...
      <FilePond
        ...
        name="files"
        labelIdle='<p class=" font-medium">Drag & Drop your files or <span class="filepond--label-action">Browse</span></p>'
      />
      <p className='absolute bg-[#fcfeff] bottom-12 py-[1px] w-full  text-[12px] text-gray-600'>You can upload max 10 Files : File max size: 10 MB</p>
      <button className='buttonBlue my-8 mb-2 w-20' onClick={onSubmit}>Submit</button>
