      ...
      <div>
        ...
        >
          <div className='flex items-center justify-between py-5 px-4 rounded-3xl bg-[#F2F1F9]'>
            ...
            <p className='text-[17px]'>Download the Return Receive mobile app for a seamless return experience</p>
            </div>
            <div className='mr-5'>
                <Image src='/images/btn-google-play.png' alt='' width={138} height={40}/>
            </div>
          </div>
