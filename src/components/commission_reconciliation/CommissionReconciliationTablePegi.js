...
import { getdata , getLength} from '@/alldatafiles/commissionreconciliationdata';


export default function CommissionReconciliationTablePegi() {
        ...
        <table className="w-[1300px] 2xl:w-full">
              <thead>  
                  <tr className=' text-[13px]  text-left font-semibold   text-gray-500'>
                      ...
                      <th><h1 className='px-2'>Applicable Commission %</h1></th>
                      <th><h1 className='px-2'>Applicable Commission Fee</h1></th>
                      <th><h1 className='px-2'>Applied Commission %</h1></th>
                      <th><h1 className='px-2'>Applied Commission Fee</h1></th>
              ...
              <tbody>
                  ...
                  <tr key={i} className='max-h-[54px] h-[54px] border-t text-sm text-black'>
                      ...
                      <td className='px-2'>{data.applicableCommission}</td>
                      <td className='px-2'>{data.applicableCommissionFee}</td>
                      <td className='px-2'>{data.appliedCommission}</td>
                      <td className='px-2'>{data.appliedCommissionFee}</td>
