...
export default function TurnoverAction() {
  return (
    <div>
     <div className='flex items-center justify-between py-3 px-4 rounded-3xl bg-[#f1f8f6]'>
                    ...
                    <p className='text-sm w-[90%]'>60% customers improved inventory turnover rates within first 6 months of using eVanik</p>
                    </div>
                    <div className=' bg-[#c8e3da] py-3 px-7 rounded-xl'>
                        <button className='text-[#1f674f] font-semibold'>Action</button>
                    </div>
       </div>
