...
import BrandWisePerformanceTablePegi from './BrandWisePerformanceTablePegi'
import { IoIosSearch } from 'react-icons/io';
import Image from '../../../node_modules/next/image'

export default function BrandWisePerformanceCantainer() {
  ...
  return (
    <div className='sm:pt-7 sm:pl-7 sm:pr-9 xl:pr-14 p-5 '>
            ...
            <p className='sm:text-4xl text-3xl font-semibold text-[#3a3b4c]'>Brand Wise Performance</p>
